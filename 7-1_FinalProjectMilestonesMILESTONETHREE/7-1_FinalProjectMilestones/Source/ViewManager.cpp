...
//	File: ViewManager.h
// ============
//	Description: Manage the viewing of 3D objects within the viewport
//	Purpose: Implements window creation, camera handling, and input
 ...
 *  Scroll_Callback()
 *
 *  This method is called from GLFW when
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// Switch between orthographic (2D) and perspective (3D) projections
